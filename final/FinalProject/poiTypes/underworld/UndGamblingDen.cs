...
public class UndGamblingDen : UnderworldPOI
{
    private List<Person> staff = new List<Person>();
    private Random random = new Random();

    public UndGamblingDen(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Gambling Den: {GetName()}");
