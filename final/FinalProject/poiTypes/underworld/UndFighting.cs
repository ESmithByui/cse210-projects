...
public class UndFighting : UnderworldPOI
{
    private List<Person> staff = new List<Person>();
    private Random random = new Random();

    public UndFighting(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Underground Fighting Ring: {GetName()}");
