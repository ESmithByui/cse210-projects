...
public class TradeStable : TradesmanPOI
{
    public TradeStable(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier, gen)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Stable: {GetName()}");
