...
public class CraftStonemason : CraftsmanPOI
{
    public CraftStonemason(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier, gen)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Stonemason: {GetName()}");
