...
public class CraftGlassmaker : CraftsmanPOI
{
    public CraftGlassmaker(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier, gen)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Glassmaker: {GetName()}");
