...
public class CraftSculptor : CraftsmanPOI
{
    public CraftSculptor(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier, gen)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Sculptor: {GetName()}");
