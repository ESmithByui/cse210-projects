...
public class CraftBlacksmith : CraftsmanPOI
{
    public CraftBlacksmith(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier, gen)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Blacksmith: {GetName()}");
