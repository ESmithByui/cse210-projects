...
public class CraftLeatherworker : CraftsmanPOI
{
    public CraftLeatherworker(string name, Person owner, int tier, PersonGenerator gen) : base(name, owner, tier, gen)
    {
    ...
    public override List<string> DisplayPOI()
    {
        ...
        returnString.Add($"Leatherworker: {GetName()}");
